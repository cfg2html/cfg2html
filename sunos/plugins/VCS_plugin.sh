#!/bin/ksh
# This is a Veritas Cluster Services Plugin for cfg2html written by
# by ROSE SWE, http://www.cfg2html.com. I found this utility so useful that
# I spent a few hours after a peoplesoft outage in the office sorting out 
# VCS Support. I hope this code is of as much use to others as it was to me.
...
case $1 in
	...
	* )
	echo "OS Type: $OSREV Not Supported By Script."
	exit 1
	echo 
